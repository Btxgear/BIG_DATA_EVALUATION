...
public class YearsRepartition implements Serializable {
        ...
        public void run(String inputDirectoryPath, String outputFilePath) {
                ...
                Dataset<Row> result = df.groupBy("release_year")
                                .count()
